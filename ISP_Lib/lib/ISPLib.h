...
DLL_EXPORT  unsigned int ISP_Read(io_handle_t* handle, unsigned char* pcBuffer,
                                  unsigned int szMaxLen, unsigned int dwMilliseconds, unsigned int bCheckIndex);
DLL_EXPORT  unsigned int ISP_Write(io_handle_t* handle, unsigned int uCmd, unsigned char *pcBuffer,
                                   unsigned int dwLen, unsigned int dwMilliseconds);
...
DLL_EXPORT  void ISP_UpdateDataFlash(io_handle_t* handle, unsigned int start_addr,
                                     unsigned int total_len, unsigned int cur_addr, unsigned char *buffer, unsigned int *update_len);
...
DLL_EXPORT  unsigned int ISP_EraseSPI(io_handle_t* handle, unsigned int offset,
                                      unsigned int total_len);
DLL_EXPORT  unsigned int ISP_UpdateSPI(io_handle_t* handle, unsigned int start_addr,
                                       unsigned int total_len, const char *buffer);

DLL_EXPORT  unsigned int ISP_CAN_Write(io_handle_t* handle, unsigned int uCmd, unsigned int uData,
