...
################################################################################
## Form generated from reading UI file 'config_type_M031.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 417, 597))
        ...
        self.gridLayout_7.addWidget(self.checkBox_bw_1, 1, 1, 1, 1)
        ...
        self.gridGroupBox_rst = QGroupBox(self.scrollAreaWidgetContents)
        self.gridGroupBox_rst.setObjectName(u"gridGroupBox_rst")
        self.gridLayout_11 = QGridLayout(self.gridGroupBox_rst)
        self.gridLayout_11.setObjectName(u"gridLayout_11")
        self.radioButton_rst_0 = QRadioButton(self.gridGroupBox_rst)
        self.radioButton_rst_0.setObjectName(u"radioButton_rst_0")

        self.gridLayout_11.addWidget(self.radioButton_rst_0, 0, 0, 1, 1)

        self.radioButton_rst_1 = QRadioButton(self.gridGroupBox_rst)
        self.radioButton_rst_1.setObjectName(u"radioButton_rst_1")
        ...
        self.gridGroupBox_ext = QGroupBox(self.scrollAreaWidgetContents)
        self.gridGroupBox_ext.setObjectName(u"gridGroupBox_ext")
        self.gridLayout_12 = QGridLayout(self.gridGroupBox_ext)
        self.gridLayout_12.setObjectName(u"gridLayout_12")
        self.radioButton_ext_0 = QRadioButton(self.gridGroupBox_ext)
        self.radioButton_ext_0.setObjectName(u"radioButton_ext_0")

        self.gridLayout_12.addWidget(self.radioButton_ext_0, 0, 0, 1, 1)

        self.radioButton_ext_1 = QRadioButton(self.gridGroupBox_ext)
        self.radioButton_ext_1.setObjectName(u"radioButton_ext_1")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_1.setText(QCoreApplication.translate("Dialog", u"2.0V", None))
        self.radioButton_bw_v_0.setText(QCoreApplication.translate("Dialog", u"2.5V", None))
        ...
        self.gridGroupBox_rst.setTitle(QCoreApplication.translate("Dialog", u"RST Pin Width Selection", None))
        self.radioButton_rst_0.setText(QCoreApplication.translate("Dialog", u"Debounce Width 32us", None))
        self.radioButton_rst_1.setText(QCoreApplication.translate("Dialog", u"Debounce Width 2us", None))
        self.gridGroupBox_ext.setTitle(QCoreApplication.translate("Dialog", u"Chip Reset Time Extend", None))
        self.radioButton_ext_0.setText(QCoreApplication.translate("Dialog", u"Extend Reset Time to 3.2ms", None))
        self.radioButton_ext_1.setText(QCoreApplication.translate("Dialog", u"Extend Reset Time to 26.6ms", None))
        self.gridGroupBox_hxt.setTitle(QCoreApplication.translate("Dialog", u"HXT Mode Selection", None))
        self.radioButton_hxt_1.setText(QCoreApplication.translate("Dialog", u"External Clock Mode", None))
