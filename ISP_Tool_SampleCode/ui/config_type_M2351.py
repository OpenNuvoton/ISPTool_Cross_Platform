...
################################################################################
## Form generated from reading UI file 'config_type_M2351.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_bt = QCheckBox(self.gridGroupBox_boot)
        self.checkBox_bt.setObjectName(u"checkBox_bt")
        ...
        self.radioButton_mf2_4 = QRadioButton(self.gridGroupBox_multi_function_2)
        self.radioButton_mf2_4.setObjectName(u"radioButton_mf2_4")
        ...
        self.gridLayout_3 = QGridLayout(self.gridGroupBox_wdt)
        ...
        self.gridLayout_9 = QGridLayout(self.gridGroupBox_misc)
        ...
        self.checkBox_tamper = QCheckBox(self.gridGroupBox_misc)
        self.checkBox_tamper.setObjectName(u"checkBox_tamper")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_bt.setText(QCoreApplication.translate("Dialog", u"Boot Loader with IAP", None))
        ...
        self.radioButton_mf2_0.setText(QCoreApplication.translate("Dialog", u"PA.3/PA.2", None))
        self.radioButton_mf2_2.setText(QCoreApplication.translate("Dialog", u"PF.0/PF/1", None))
        self.radioButton_mf2_3.setText(QCoreApplication.translate("Dialog", u"PA.9/PA.8", None))
        self.radioButton_mf2_1.setText(QCoreApplication.translate("Dialog", u"PB.3/PB.2", None))
        self.radioButton_mf2_4.setText(QCoreApplication.translate("Dialog", u"PB.7/PB.6", None))
        ...
        self.checkBox_ice_lock.setText(QCoreApplication.translate("Dialog", u"Disabled ICE function", None))
        self.checkBox_tamper.setText(QCoreApplication.translate("Dialog", u"Tamper Domain Power Down", None))
