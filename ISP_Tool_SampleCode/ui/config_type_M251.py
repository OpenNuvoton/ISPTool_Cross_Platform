...
################################################################################
## Form generated from reading UI file 'config_type_M251.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridGroupBox_bootclk = QGroupBox(self.scrollAreaWidgetContents)
        self.gridGroupBox_bootclk.setObjectName(u"gridGroupBox_bootclk")
        self.gridLayout_5 = QGridLayout(self.gridGroupBox_bootclk)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.radioButton_mf_1 = QRadioButton(self.gridGroupBox_bootclk)
        self.radioButton_mf_1.setObjectName(u"radioButton_mf_1")

        self.gridLayout_5.addWidget(self.radioButton_mf_1, 0, 1, 1, 1)

        self.radioButton_mf_0 = QRadioButton(self.gridGroupBox_bootclk)
        ...
        self.verticalLayout.addWidget(self.gridGroupBox_bootclk)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.gridGroupBox_bootclk.setTitle(QCoreApplication.translate("Dialog", u"Booting Clock Selection", None))
        self.radioButton_mf_1.setText(QCoreApplication.translate("Dialog", u"4MHz", None))
        self.radioButton_mf_0.setText(QCoreApplication.translate("Dialog", u"1MHz", None))
