...
# Form implementation generated from reading ui file 'config_type_M251.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridGroupBox_bootclk = QtWidgets.QGroupBox(Dialog)
        self.gridGroupBox_bootclk.setObjectName("gridGroupBox_bootclk")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.gridGroupBox_bootclk)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.radioButton_mf_1 = QtWidgets.QRadioButton(self.gridGroupBox_bootclk)
        self.radioButton_mf_1.setObjectName("radioButton_mf_1")
        self.gridLayout_5.addWidget(self.radioButton_mf_1, 0, 1, 1, 1)
        self.radioButton_mf_0 = QtWidgets.QRadioButton(self.gridGroupBox_bootclk)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.gridGroupBox_bootclk.setTitle(_translate("Dialog", "Booting Clock Selection"))
        self.radioButton_mf_1.setText(_translate("Dialog", "4MHz"))
        self.radioButton_mf_0.setText(_translate("Dialog", "1MHz"))
