...
################################################################################
## Form generated from reading UI file 'config_type_M2L31.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_mf_1.setText(QCoreApplication.translate("Dialog", u"PA.1/PA.0", None))
        self.radioButton_mf_0.setText(QCoreApplication.translate("Dialog", u"PB.12/PB.13", None))
        self.radioButton_mf_2.setText(QCoreApplication.translate("Dialog", u"PA.7/PA.6", None))
        ...
        self.gridGroupBox_misc.setTitle(QCoreApplication.translate("Dialog", u"Secure Lock", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Dialog", u"Config 0-6", None))
        self.label_11.setText(QCoreApplication.translate("Dialog", u"Total Region Range: 0x00000 ~ 0x7FFFF", None))
        self.label_12.setText(QCoreApplication.translate("Dialog", u"Single Region Size: 0x02000", None))
