...
################################################################################
## Form generated from reading UI file 'config_type_M480.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 443, 682))
        ...
        self.checkBox = QCheckBox(self.gridGroupBox_boot)
        ...
        self.gridLayout_11 = QGridLayout(self.gridGroupBox_multi_function)
        ...
        self.gridGroupBox_multi_function_2 = QGroupBox(self.scrollAreaWidgetContents)
        self.gridGroupBox_multi_function_2.setObjectName(u"gridGroupBox_multi_function_2")
        self.gridLayout_12 = QGridLayout(self.gridGroupBox_multi_function_2)
        self.gridLayout_12.setObjectName(u"gridLayout_12")
        self.radioButton_mf2_1 = QRadioButton(self.gridGroupBox_multi_function_2)
        self.radioButton_mf2_1.setObjectName(u"radioButton_mf2_1")

        self.gridLayout_12.addWidget(self.radioButton_mf2_1, 0, 1, 1, 1)

        self.radioButton_mf2_0 = QRadioButton(self.gridGroupBox_multi_function_2)
        self.radioButton_mf2_0.setObjectName(u"radioButton_mf2_0")

        self.gridLayout_12.addWidget(self.radioButton_mf2_0, 0, 0, 1, 1)

        self.radioButton_mf2_2 = QRadioButton(self.gridGroupBox_multi_function_2)
        self.radioButton_mf2_2.setObjectName(u"radioButton_mf2_2")

        self.gridLayout_12.addWidget(self.radioButton_mf2_2, 1, 0, 1, 1)

        self.radioButton_mf2_3 = QRadioButton(self.gridGroupBox_multi_function_2)
        self.radioButton_mf2_3.setObjectName(u"radioButton_mf2_3")
        ...
        self.gridGroupBox_hxt = QGroupBox(self.scrollAreaWidgetContents)
        self.gridGroupBox_hxt.setObjectName(u"gridGroupBox_hxt")
        self.gridLayout_5 = QGridLayout(self.gridGroupBox_hxt)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.radioButton_hxt_1 = QRadioButton(self.gridGroupBox_hxt)
        self.radioButton_hxt_1.setObjectName(u"radioButton_hxt_1")

        self.gridLayout_5.addWidget(self.radioButton_hxt_1, 0, 1, 1, 1)

        self.radioButton_hxt_0 = QRadioButton(self.gridGroupBox_hxt)
        self.radioButton_hxt_0.setObjectName(u"radioButton_hxt_0")
        ...
        self.checkBox_sprom_lock = QCheckBox(self.gridGroupBox_misc)
        self.checkBox_sprom_lock.setObjectName(u"checkBox_sprom_lock")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox.setText(QCoreApplication.translate("Dialog", u"Boot Loader", None))
        self.gridGroupBox_multi_function.setTitle(QCoreApplication.translate("Dialog", u"Boot Loader SPIM CLK/SS/MISO/MOSI Multi-function Pin Select", None))
        self.radioButton_mf_1.setText(QCoreApplication.translate("Dialog", u"PC.2/PC.3/PC.1/PC.0", None))
        self.radioButton_mf_0.setText(QCoreApplication.translate("Dialog", u"PA.2/PA.3/PA.1/PA.0", None))
        self.radioButton_mf_2.setText(QCoreApplication.translate("Dialog", u"PG.12/PG.11/PG.13/PG.14", None))
        self.radioButton_mf_3.setText(QCoreApplication.translate("Dialog", u"PE.4/PE.5/PE.3/PE.2", None))
        self.gridGroupBox_multi_function_2.setTitle(QCoreApplication.translate("Dialog", u"Boot Loader UART1 TXD/RXD Multi-function Pin Select", None))
        self.radioButton_mf2_1.setText(QCoreApplication.translate("Dialog", u"PA.9/PA.8", None))
        self.radioButton_mf2_0.setText(QCoreApplication.translate("Dialog", u"PB.3/PB.2", None))
        self.radioButton_mf2_2.setText(QCoreApplication.translate("Dialog", u"PA.3/PA.2", None))
        self.radioButton_mf2_3.setText(QCoreApplication.translate("Dialog", u"PB.7/PB.6", None))
        self.gridGroupBox_hxt.setTitle(QCoreApplication.translate("Dialog", u"HXT Mode Selection", None))
        self.radioButton_hxt_1.setText(QCoreApplication.translate("Dialog", u"External Clock Source Mode", None))
        self.radioButton_hxt_0.setText(QCoreApplication.translate("Dialog", u"Crystal Mode", None))
        ...
        self.checkBox_sprom_lock.setText(QCoreApplication.translate("Dialog", u"SPROM Lock Cacheable", None))
