...
################################################################################
## Form generated from reading UI file 'config_type_M480LD.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 443, 663))
        ...
        self.checkBox_security_boot_lock = QCheckBox(self.gridGroupBox_misc)
        self.checkBox_security_boot_lock.setObjectName(u"checkBox_security_boot_lock")

        self.gridLayout_3.addWidget(self.checkBox_security_boot_lock, 2, 0, 1, 1)

        self.checkBox_ice_lock = QCheckBox(self.gridGroupBox_misc)
        self.checkBox_ice_lock.setObjectName(u"checkBox_ice_lock")

        self.gridLayout_3.addWidget(self.checkBox_ice_lock, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_security_boot_lock.setText(QCoreApplication.translate("Dialog", u"Security Boot Lock", None))
