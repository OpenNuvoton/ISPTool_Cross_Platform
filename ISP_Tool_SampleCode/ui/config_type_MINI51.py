...
################################################################################
## Form generated from reading UI file 'config_type_MINI51.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setBaseSize(QSize(600, 600))
        ...
        self.gridLayout_7.addWidget(self.checkBox_bw_1, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_2.setText(QCoreApplication.translate("Dialog", u"BOD Disabled", None))
        self.radioButton_bw_v_0.setText(QCoreApplication.translate("Dialog", u"3.8V", None))
        self.radioButton_bw_v_1.setText(QCoreApplication.translate("Dialog", u"2.7V", None))
