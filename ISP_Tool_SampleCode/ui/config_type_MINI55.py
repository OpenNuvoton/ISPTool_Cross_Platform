...
# Form implementation generated from reading ui file 'ui/config_type_MINI55.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridGroupBox_RC = QtWidgets.QGroupBox(Dialog)
        self.gridGroupBox_RC.setObjectName("gridGroupBox_RC")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.gridGroupBox_RC)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.radioButton_rc_1 = QtWidgets.QRadioButton(self.gridGroupBox_RC)
        self.radioButton_rc_1.setObjectName("radioButton_rc_1")
        self.gridLayout_10.addWidget(self.radioButton_rc_1, 1, 0, 1, 1)
        self.radioButton_rc_0 = QtWidgets.QRadioButton(self.gridGroupBox_RC)
        self.radioButton_rc_0.setObjectName("radioButton_rc_0")
        self.gridLayout_10.addWidget(self.radioButton_rc_0, 0, 0, 1, 1)
        self.radioButton_rc_2 = QtWidgets.QRadioButton(self.gridGroupBox_RC)
        self.radioButton_rc_2.setObjectName("radioButton_rc_2")
        self.gridLayout_10.addWidget(self.radioButton_rc_2, 0, 1, 1, 1)
        self.radioButton_rc_3 = QtWidgets.QRadioButton(self.gridGroupBox_RC)
        self.radioButton_rc_3.setObjectName("radioButton_rc_3")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_2.setText(_translate("Dialog", "3.0V"))
        self.radioButton_bw_v_3.setText(_translate("Dialog", "2.7V"))
        self.radioButton_bw_v_0.setText(_translate("Dialog", "4.3V"))
        self.radioButton_bw_v_1.setText(_translate("Dialog", "3.7V"))
        self.radioButton_bw_v_4.setText(_translate("Dialog", "2.4V"))
        self.radioButton_bw_v_5.setText(_translate("Dialog", "2.2V"))
        self.radioButton_bw_v_8.setText(_translate("Dialog", "BOD Disabled"))
        self.radioButton_bw_v_7.setText(_translate("Dialog", "1.7V"))
        self.radioButton_bw_v_6.setText(_translate("Dialog", "2.0V"))
        ...
        self.gridGroupBox_RC.setTitle(_translate("Dialog", "RC Oscillator Trim Options"))
        self.radioButton_rc_1.setText(_translate("Dialog", "22.1184MHz"))
        self.radioButton_rc_0.setText(_translate("Dialog", "44.2368MHz"))
        self.radioButton_rc_2.setText(_translate("Dialog", "48MHz"))
        self.radioButton_rc_3.setText(_translate("Dialog", "24MHZ"))
