...
################################################################################
## Form generated from reading UI file 'config_type_NANO103.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radioButton_bw_v_9 = QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_9.setObjectName(u"radioButton_bw_v_9")

        self.gridLayout_7.addWidget(self.radioButton_bw_v_9, 2, 1, 1, 1)
        ...
        self.radioButton_bw_v_10 = QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_10.setObjectName(u"radioButton_bw_v_10")

        self.gridLayout_7.addWidget(self.radioButton_bw_v_10, 2, 2, 1, 1)
        ...
        self.radioButton_bw_v_11 = QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_11.setObjectName(u"radioButton_bw_v_11")

        self.gridLayout_7.addWidget(self.radioButton_bw_v_11, 2, 3, 1, 1)

        self.radioButton_bw_v_12 = QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_12.setObjectName(u"radioButton_bw_v_12")

        self.gridLayout_7.addWidget(self.radioButton_bw_v_12, 3, 0, 1, 1)

        self.radioButton_bw_v_13 = QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_13.setObjectName(u"radioButton_bw_v_13")

        self.gridLayout_7.addWidget(self.radioButton_bw_v_13, 3, 1, 1, 1)

        self.checkBox_bw_0 = QCheckBox(self.gridGroupBox_brownout)
        self.checkBox_bw_0.setObjectName(u"checkBox_bw_0")

        self.gridLayout_7.addWidget(self.checkBox_bw_0, 3, 2, 1, 1)
        ...
        self.checkBox = QCheckBox(self.gridGroupBox_misc)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_2.setText(QCoreApplication.translate("Dialog", u"2.9V", None))
        self.radioButton_bw_v_3.setText(QCoreApplication.translate("Dialog", u"2.8V", None))
        self.radioButton_bw_v_0.setText(QCoreApplication.translate("Dialog", u"3.1V", None))
        self.radioButton_bw_v_1.setText(QCoreApplication.translate("Dialog", u"3.0V", None))
        self.radioButton_bw_v_4.setText(QCoreApplication.translate("Dialog", u"2.7V", None))
        self.radioButton_bw_v_9.setText(QCoreApplication.translate("Dialog", u"2.2V", None))
        self.radioButton_bw_v_5.setText(QCoreApplication.translate("Dialog", u"2.6V", None))
        self.radioButton_bw_v_8.setText(QCoreApplication.translate("Dialog", u"2.3V", None))
        self.radioButton_bw_v_10.setText(QCoreApplication.translate("Dialog", u"2.1V", None))
        self.radioButton_bw_v_7.setText(QCoreApplication.translate("Dialog", u"2.4V", None))
        self.radioButton_bw_v_6.setText(QCoreApplication.translate("Dialog", u"2.5V", None))
        self.radioButton_bw_v_11.setText(QCoreApplication.translate("Dialog", u"2.0V", None))
        self.radioButton_bw_v_12.setText(QCoreApplication.translate("Dialog", u"1.9V", None))
        self.radioButton_bw_v_13.setText(QCoreApplication.translate("Dialog", u"1.8V", None))
        ...
        self.checkBox.setText(QCoreApplication.translate("Dialog", u"System clock stop detection", None))
