...
# Form implementation generated from reading ui file 'config_type_NANO103.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radioButton_bw_v_9 = QtWidgets.QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_9.setObjectName("radioButton_bw_v_9")
        ...
        self.radioButton_bw_v_8 = QtWidgets.QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_8.setObjectName("radioButton_bw_v_8")
        self.gridLayout_7.addWidget(self.radioButton_bw_v_8, 2, 0, 1, 1)
        self.radioButton_bw_v_10 = QtWidgets.QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_10.setObjectName("radioButton_bw_v_10")
        ...
        self.radioButton_bw_v_11 = QtWidgets.QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_11.setObjectName("radioButton_bw_v_11")
        self.gridLayout_7.addWidget(self.radioButton_bw_v_11, 2, 3, 1, 1)
        self.radioButton_bw_v_12 = QtWidgets.QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_12.setObjectName("radioButton_bw_v_12")
        self.gridLayout_7.addWidget(self.radioButton_bw_v_12, 3, 0, 1, 1)
        self.radioButton_bw_v_13 = QtWidgets.QRadioButton(self.gridGroupBox_brownout)
        self.radioButton_bw_v_13.setObjectName("radioButton_bw_v_13")
        ...
        self.checkBox = QtWidgets.QCheckBox(self.gridGroupBox_misc)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_2.setText(_translate("Dialog", "2.9V"))
        self.radioButton_bw_v_3.setText(_translate("Dialog", "2.8V"))
        self.radioButton_bw_v_0.setText(_translate("Dialog", "3.1V"))
        self.radioButton_bw_v_1.setText(_translate("Dialog", "3.0V"))
        self.radioButton_bw_v_4.setText(_translate("Dialog", "2.7V"))
        self.radioButton_bw_v_9.setText(_translate("Dialog", "2.2V"))
        self.radioButton_bw_v_5.setText(_translate("Dialog", "2.6V"))
        self.radioButton_bw_v_8.setText(_translate("Dialog", "2.3V"))
        self.radioButton_bw_v_10.setText(_translate("Dialog", "2.1V"))
        self.radioButton_bw_v_7.setText(_translate("Dialog", "2.4V"))
        self.radioButton_bw_v_6.setText(_translate("Dialog", "2.5V"))
        self.radioButton_bw_v_11.setText(_translate("Dialog", "2.0V"))
        self.radioButton_bw_v_12.setText(_translate("Dialog", "1.9V"))
        self.radioButton_bw_v_13.setText(_translate("Dialog", "1.8V"))
        ...
        self.checkBox.setText(_translate("Dialog", "System clock stop detection"))
