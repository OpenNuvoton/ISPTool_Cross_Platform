...
# Form implementation generated from reading ui file 'ui/config_type_NM1500.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridGroupBox_pwm = QtWidgets.QGroupBox(Dialog)
        self.gridGroupBox_pwm.setObjectName("gridGroupBox_pwm")
        self.gridLayout_pwm = QtWidgets.QGridLayout(self.gridGroupBox_pwm)
        self.gridLayout_pwm.setObjectName("gridLayout_pwm")
        self.checkBox = QtWidgets.QCheckBox(self.gridGroupBox_pwm)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout_pwm.addWidget(self.checkBox, 0, 0, 1, 1)
        self.checkBox_3 = QtWidgets.QCheckBox(self.gridGroupBox_pwm)
        self.checkBox_3.setObjectName("checkBox_3")
        self.gridLayout_pwm.addWidget(self.checkBox_3, 1, 1, 1, 1)
        self.checkBox_2 = QtWidgets.QCheckBox(self.gridGroupBox_pwm)
        self.checkBox_2.setObjectName("checkBox_2")
        self.gridLayout_pwm.addWidget(self.checkBox_2, 1, 0, 1, 1)
        self.checkBox_4 = QtWidgets.QCheckBox(self.gridGroupBox_pwm)
        self.checkBox_4.setObjectName("checkBox_4")
        self.gridLayout_pwm.addWidget(self.checkBox_4, 2, 0, 1, 1)
        self.checkBox_5 = QtWidgets.QCheckBox(self.gridGroupBox_pwm)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.gridGroupBox_pwm.setTitle(_translate("Dialog", "PWM Tri-State"))
        self.checkBox.setText(_translate("Dialog", "Basic PWM Tri-State"))
        self.checkBox_3.setText(_translate("Dialog", "PWM Odd0 Tri-State"))
        self.checkBox_2.setText(_translate("Dialog", "PWM Even0 Tri-State"))
        self.checkBox_4.setText(_translate("Dialog", "PWM Even1 Tri-State"))
        self.checkBox_5.setText(_translate("Dialog", "PWM Odd1 Tri-State"))
