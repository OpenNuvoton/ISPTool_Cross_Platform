...
################################################################################
## Form generated from reading UI file 'config_type_NUC200.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(442, 483)
        Dialog.setSizeIncrement(QSize(600, 720))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 428, 469))
        ...
        self.checkBox_dataflash_size = QCheckBox(self.gridGroupBox_data_flash)
        self.checkBox_dataflash_size.setObjectName(u"checkBox_dataflash_size")

        self.gridLayout_9.addWidget(self.checkBox_dataflash_size, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_1.setText(QCoreApplication.translate("Dialog", u"3.8V", None))
        ...
        self.gridGroupBox_multi_function.setTitle(QCoreApplication.translate("Dialog", u"PF[1:0] Multi-Function Options", None))
        ...
        self.checkBox_dataflash_size.setText(QCoreApplication.translate("Dialog", u"Data Flash Variable Size", None))
