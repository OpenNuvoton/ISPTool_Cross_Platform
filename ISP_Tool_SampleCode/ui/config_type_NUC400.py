...
################################################################################
## Form generated from reading UI file 'config_type_NUC400.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 415, 491))
        ...
        self.gridLayout_10 = QGridLayout(self.gridGroupBox_multi_function_2)
        ...
        self.gridLayout_10.addWidget(self.radioButton_mf2_0, 0, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.radioButton_mf2_1, 0, 1, 1, 1)
        ...
        self.radioButton = QRadioButton(self.gridGroupBox)
        self.radioButton.setObjectName(u"radioButton")

        self.gridLayout_11.addWidget(self.radioButton, 0, 0, 1, 1)

        self.radioButton_2 = QRadioButton(self.gridGroupBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_bw_v_0.setText(QCoreApplication.translate("Dialog", u"4.5V", None))
        ...
        self.gridGroupBox_multi_function.setTitle(QCoreApplication.translate("Dialog", u"GPG[13:12] Multi-Function Options", None))
        ...
        self.gridGroupBox_multi_function_2.setTitle(QCoreApplication.translate("Dialog", u"GPG[15:14] Multi-Function Options", None))
        self.radioButton_mf2_0.setText(QCoreApplication.translate("Dialog", u"GPIO", None))
        self.radioButton_mf2_1.setText(QCoreApplication.translate("Dialog", u"External 32KHz Crystal Pin", None))
        ...
        self.gridGroupBox.setTitle(QCoreApplication.translate("Dialog", u"EMAC Interface Options", None))
        self.radioButton.setText(QCoreApplication.translate("Dialog", u"MII Mode", None))
        self.radioButton_2.setText(QCoreApplication.translate("Dialog", u"RMII Mode", None))
